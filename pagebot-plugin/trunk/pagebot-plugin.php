    ...
    ?> 
	 <div class="wrap">
        ...
        <form method="post" action="options.php">
            <?php settings_fields('pagebot-settings-group'); ?>
            <?php do_settings_sections('pagebot-settings-group'); ?>
...
function my_script_plugin_settings() {
    register_setting('pagebot-settings-group', 'your_id');
	register_setting('pagebot-settings-group', 'pgbt_sources', 'sanitize_pgbt_sources');
}
